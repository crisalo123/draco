  ...
  return (
    <header className="sticky top-0 z-40 border-b border-emerald-100/10 bg-[#0f1f16]/85 backdrop-blur-xl">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 sm:px-6">
        ...
        >
          <span className="relative flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-full border-2 border-denuded-gold/45 bg-[#ecf7ed] shadow-[0_0_16px_rgba(143,212,168,0.2)] sm:h-16 sm:w-16 md:h-[4.5rem] md:w-[4.5rem]">
            <img
              src={BRAND_LOGO_URL}
              alt=""
              decoding="async"
              draggable={false}
              className="h-full w-full scale-[1.03] object-cover object-center transform-gpu"
            />
          </span>
